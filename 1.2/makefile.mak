...
CXX := g++
CXXFLAGS := -std=c++11 -c -Wall -IS:\Datenban\Wetter\Programme\akterm\1.2\lib\\
LDFLAGS := -g -static
HEADERS := $(wildcard S\:\Datenban\Wetter\Programme\akterm\1.2\lib\*.h)
objs := main.o file_creation.o Date.o Coordinates.o Situation.o

default: akterm_v1-2.exe

# Ziel 1
akterm_v1-2.exe: $(objs)
	$(CXX) $(LDFLAGS) -o $@ $^
